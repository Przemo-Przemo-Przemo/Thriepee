...
export class IntroductionComponent implements OnInit {
  ...
  public selectedWhatWeDoSummary: String = "Art & Comedy";
  ...
  public whatWeDoPhotos: WhatWeDoPhoto[] = [
    ...
    { title: "Art & Comedy", path: "../assets/what-we-do/photos/art.jpg", description:"Art comes in many ways. Accept our art or be known as an uncultured lolipop. Also dank memes 24/7 non stop (no please son dont leave i am a millenial!)"},
